...
<form action="admin.php?page=groups&amp;add=1&amp;start=1" method="post">
    <table width="70%" class="t_style_b" border="1" align="center">
      <tr>
        <td class="main1 rows_space" colspan="2">اضافة مجموعه جديده</td>
      </tr>
      <tr>
        <td class="row1" width="50%">اسم المجموعه</td>
        <td class="row1" width="50%"><input type="text" name="name"></td>
      </tr>

      <tr>
        <td class="row2" width="50%">شكل اسم المستخدم في المجموعه</td>
        <td class="row2" width="50%"><input type="text" dir="ltr" value="[username]" name="style"></td>
      </tr>
      <tr>
        <td class="row1" width="50%">مسمى العضو</td>
        <td class="row1" width="50%"><input type="text" name="usertitle"></td>
      </tr>

      <tr>
        <td class="row2" width="50%">الترتيب</td>
        <td class="row2" width="50%"><input name="group_order" type="text" size="9"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="row1" width="50%"><input name="download_attach_number" type="text" value="0" size="5"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="row1" width="50%"><input name="upload_attach_num" type="text" value="0" size="5"></td>
      </tr>
      <tr>
