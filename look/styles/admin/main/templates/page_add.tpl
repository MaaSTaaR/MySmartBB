...
<div class="address_bar">لوحة التحكم &raquo; <a href="admin.php?page=pages&amp;control=1&amp;main=1">الصفحات الخارجيه</a> &raquo; اضافه</div>
...
<tr valign="top" align="center">
	<td class="main1" colspan="2">اضافة صفحه جديده</td>
</tr>
<tr valign="top">
