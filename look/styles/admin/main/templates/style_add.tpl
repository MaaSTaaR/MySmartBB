...
<div class="address_bar">لوحة التحكم &raquo; <a href="admin.php?page=style&amp;control=1&amp;main=1">الانماط</a> &raquo; اضافه</div>
...
<tr valign="top" align="center">
	<td class="main1" colspan="2">اضافة نمط جديد</td>
</tr>
<tr valign="top">
