...
<tr valign="top" align="center">
	...
	<td class="row1"><a href="admin.php?page=member&amp;edit=1&amp;main=1&amp;id={$MembersList['id']}">تحرير</a></td>
	<td class="row1"><a href="admin.php?page=member&amp;del=1&amp;main=1&amp;id={$MembersList['id']}">حذف</a></td>
</tr>
{/Des::while}
</table>
