...
<form action="admin.php?page=forums&amp;add=1&amp;start=1" name="myform" method="post">
<table cellpadding="3" cellspacing="1" width="90%" class="t_style_b" border="1" align="center">
<tr valign="top" align="center">
	<td class="main1" colspan="2">اضافة منتدى جديد</td>
</tr>
<tr valign="top">
...
<tr valign="top">
		<td class="row2">القسم الاساسي</td>
		<td class="row2">
...
<tr valign="top" align="center">
	...
	<td class="main2">كتابة موضوع</td>
	<td class="main2">كتابة رد</td>
</tr>
{Des::while}{groups}
<tr valign="top" align="center">
	...
	<td class="row1">كتابة موضوع : <select name="groups[{$groups['id']}][write_subject]" id="select_write_subject">
	{if}{}groups['write_subject']{}{if}
	<option value="1" selected="selected">نعم</option>
	<option value="0">لا</option>
	{/comif}
	{else}
	...
	<td class="row2">كتابة رد : <select name="groups[{$groups['group_id']}][write_reply]" id="select_write_reply">
	{if}{}groups['write_reply']{}{if}
	<option value="1" selected="selected">نعم</option>
	<option value="0">لا</option>
	{/comif}
	{else}
