		...
		<div id="info_bar">
			...
			<div class="left_side">
				<a href="">مواضيع اليوم</a> ، <a href="">مراسلة الاداره</a>
			</div>
		</div>
		...
		<div id="footer">
			<a href="{$_SERVER['PHP_SELF']}{if {{$_SERVER['QUERY_STRING']}} != ''}?{$_SERVER['QUERY_STRING']}&amp;debug=1{else}?debug=1{/if}">Queries number</a> : {$query_num} , Memory usage : {$memory_usage} KB
		</div>
