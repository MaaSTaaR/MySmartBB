...
<a href="{$init_path}usercp">{$lang['usercp']}</a> {$_CONF['info_row']['adress_bar_separate']} {$lang['your_options']}
{template}address_bar_part2{/template}

{hook}after_adress_bar{/hook}

<form name="info" method="post" action="{$init_path}usercp_control_setting/start">
	<table id="setting_table" align="center" border="1" width="60%" class="t_style_b">
		<tr align="center">
