...
<div class="usercp_context {$_CONF['opp_align']}_side">
	...
	<a href="{$init_path}usercp">{$lang['usercp']}</a> {$_CONF['info_row']['adress_bar_separate']} {$lang['change_email']}
	{template}address_bar_part2{/template}
	
	{hook}after_adress_bar{/hook}
	
	<form method="post" action="{$init_path}usercp_control_email/start">
