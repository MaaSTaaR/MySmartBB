<div class="usercp_menu">
	<table border="1" class="t_style_b">
		<tr align="center">
     	...
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_info&amp;main=1">معلوماتك الشخصية</a>
     		</td>
     	</tr>
     	
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_setting&amp;main=1">خياراتك الخاصة</a>
     		</td>
     	</tr>
     	
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_signature&amp;main=1">تغيير التوقيع</a>
     		</td>
     	</tr>
     	
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_password&amp;main=1">تغيير الكلمة السرية</a>
     		</td>
     	</tr>
     	
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_email&amp;main=1">تغيير البريد الالكتروني</a>
     		</td>
     	</tr>
     	
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_control_avatar&amp;main=1">تغيير الصورة الشخصية</a>
     		</td>
     	</tr>
     	...
     	<tr>
     		<td class="row1" align="center">
     			<a href="index.php?page=usercp_option_subject&amp;main=1">مواضيعك الخاصة</a>
     		</td>
     	</tr>
     </table>
</div>
