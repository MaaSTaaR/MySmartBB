...
<div class="address_bar">لوحة التحكم &raquo; <a href="admin.php?page=smile&amp;control=1&amp;main=1">الابتسامات</a> &raquo; اضافة ابتسامه</div>
...
<tr valign="top" align="center">
	<td class="main1" colspan="2">اضافة ابتسامه جديده</td>
</tr>
<tr valign="top">
